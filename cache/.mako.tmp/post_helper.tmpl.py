...
_magic_number = 10
_modified_time = 1493854514.3365028
_enable_loop = True
_template_filename = '/usr/local/lib/python3.5/dist-packages/nikola/data/themes/base/templates/post_helper.tmpl'
_template_uri = 'post_helper.tmpl'
_source_encoding = 'utf-8'
_exports = ['meta_translations', 'html_pager', 'open_graph_metadata', 'twitter_card_information', 'html_tags', 'mathjax_script']
